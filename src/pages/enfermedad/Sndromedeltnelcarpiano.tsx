...
const Síndromedeltúnelcarpiano = () => {
  return (
        ...
        <div className="space-y-12">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">¿Qué es Síndrome del túnel carpiano?</h3>
                <p className="text-gray-700 mb-3">Descripción detallada de Síndrome del túnel carpiano.</p>
                <p className="text-gray-700">Impacto de Síndrome del túnel carpiano en la vida diaria.</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Causa genética o hereditaria de Síndrome del túnel carpiano</li>
                  <li>Factores ambientales asociados a Síndrome del túnel carpiano</li>
                  <li>Otras condiciones médicas relacionadas con Síndrome del túnel carpiano</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Factores de riesgo:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Historial familiar de Síndrome del túnel carpiano</li>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
                <li>Síntoma principal de Síndrome del túnel carpiano</li>
          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Criterio diagnóstico 1 para Síndrome del túnel carpiano</li>
                  <li>Criterio diagnóstico 2 para Síndrome del túnel carpiano</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  ...
                  <li>Pruebas específicas para Síndrome del túnel carpiano</li>
          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Tratamiento farmacológico para Síndrome del túnel carpiano</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Manejo de los síntomas de Síndrome del túnel carpiano</li>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div key="0" className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50">
                  <p className="text-gray-700 italic mb-2">"Ejemplo de sentencia relacionada con Síndrome del túnel carpiano y su impacto en la capacidad laboral."</p>
            ...
            <CardContent>
              <div className="mb-6">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
                    <li key="0">Historia clínica detallada de Síndrome del túnel carpiano</li>
...
export default Síndromedeltúnelcarpiano;