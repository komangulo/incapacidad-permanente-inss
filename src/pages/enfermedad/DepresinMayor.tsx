    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Depresión Mayor</h1>
          <div className="text-2xl font-semibold text-blue-600 mb-4">Incapacidad Total/Absoluta</div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Episodios recurrentes graves
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">¿Qué es Depresión Mayor?</h3>
                <p className="text-gray-700 mb-3">Descripción detallada de Depresión Mayor.</p>
                <p className="text-gray-700">Impacto de Depresión Mayor en la vida diaria.</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Causa genética o hereditaria de Depresión Mayor</li>
                  <li>Factores ambientales asociados a Depresión Mayor</li>
                  <li>Otras condiciones médicas relacionadas con Depresión Mayor</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Factores de riesgo:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Historial familiar de Depresión Mayor</li>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
                <li>Síntoma principal de Depresión Mayor</li>
          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Criterio diagnóstico 1 para Depresión Mayor</li>
                  <li>Criterio diagnóstico 2 para Depresión Mayor</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  ...
                  <li>Pruebas específicas para Depresión Mayor</li>
          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Tratamiento farmacológico para Depresión Mayor</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>Manejo de los síntomas de Depresión Mayor</li>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div key="0" className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50">
                  <p className="text-gray-700 italic mb-2">"Ejemplo de sentencia relacionada con Depresión Mayor y su impacto en la capacidad laboral."</p>
            ...
            <CardContent>
              <div className="mb-6">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
                    <li key="0">Historia clínica detallada de Depresión Mayor</li>
